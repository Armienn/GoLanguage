...
func GetSentences() []*Statement {
	return []*Statement{
		...
		StatementFromString("[:shine[doer:sun[several]][at:now]]"),
		StatementFromString("[:shine[doer:sun[several]][at:before]]"),
		StatementFromString("[:shine[doer:sun[definite][several]][at:now]]"),
		StatementFromString("[:shine[doer:sun[definite][several]][at:before]]"),
		...
		StatementFromString("[:shout[doer:person[descriptor:several]][at:before]]"),
